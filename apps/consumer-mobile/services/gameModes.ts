...
export type GameDefinition={code:string;name:string;description:string;mode:GameMode;rounds:number;accent:string;instructions:string};

export const GAME_DEFINITIONS:GameDefinition[]=[
 {code:'clean_sweep',name:'Clean Sweep',description:'Sweep away weak evidence before it contaminates the trust set.',mode:'evidence_tap',rounds:12,accent:'🧹',instructions:'Tap only the evidence you would trust.'},
 {code:'bathroom_memory',name:'Bathroom Memory',description:'Match restroom amenities with the observations that verify them.',mode:'memory',rounds:6,accent:'🧠',instructions:'Find all six matching amenity pairs.'},
 {code:'trust_or_bust',name:'Trust or Bust',description:'Separate strong evidence from weak restroom claims.',mode:'trust_quiz',rounds:8,accent:'🛡️',instructions:'Choose the strongest answer.'},
 {code:'flush_the_facts',name:'Flush the Facts',description:'Rapid-fire fact or fluff decisions under a short clock.',mode:'rapid_fire',rounds:10,accent:'⚡',instructions:'Decide FACT or FLUFF as quickly as you can.'},
 {code:'restroom_relay',name:'Restroom Relay',description:'Carry a verification baton through a complete restroom visit.',mode:'relay',rounds:8,accent:'🏃',instructions:'Complete each visit step in the strongest order.'},
 {code:'stall_strategy',name:'Stall Strategy',description:'Spend a limited evidence budget where it builds the most trust.',mode:'strategy',rounds:6,accent:'♟️',instructions:'Choose the best evidence investment each turn.'},
 {code:'sink_sprint',name:'Sink Sprint',description:'Identify sink, soap, drying, and accessibility conditions at speed.',mode:'amenity_sprint',rounds:12,accent:'🚰',instructions:'Classify the amenity condition before the next one arrives.'},
 {code:'route_to_relief',name:'Route to Relief',description:'Balance distance, freshness, accessibility, and verification to pick a stop.',mode:'route_puzzle',rounds:6,accent:'🗺️',instructions:'Pick the best stop, not merely the closest one.'},
 {code:'review_rater',name:'Review Rater',description:'Rank competing reviews by usefulness to the next visitor.',mode:'ranking',rounds:8,accent:'⭐',instructions:'Promote the most useful review to #1.'},
 {code:'evidence_detective',name:'Evidence Detective',description:'Investigate a restroom report and identify the clue that breaks trust.',mode:'detective',rounds:8,accent:'🔎',instructions:'Find the suspicious clue.'},
 {code:'amenity_architect',name:'Amenity Architect',description:'Build a complete restroom profile from a visitor scenario.',mode:'builder',rounds:6,accent:'🏗️',instructions:'Select every amenity the scenario actually supports.'},
 {code:'cleanliness_clash',name:'Cleanliness Clash',description:'Compare two evidence sets and choose which one wins the trust battle.',mode:'multiplayer_trust',rounds:8,accent:'⚔️',instructions:'Choose the stronger evidence set.'},
];

export type ChoiceRound={prompt:string;choices:string[];correct:number;detail:string};
export const MODE_ROUNDS:Record<Exclude<GameMode,'memory'|'builder'>,ChoiceRound[]>={
 ...
 strategy:[
  {prompt:'You have 2 evidence tokens. Best investment?',choices:['Check-in + current photo','Two star ratings','Two old comments'],correct:0,detail:'Independent current signals reinforce each other.'},
  {prompt:'Only one verification move remains.',choices:['Confirm accessibility fixture','Add another adjective','Repeat the star score'],correct:0,detail:'New facts beat duplicated opinion.'}],
 amenity_sprint:[
 ...
 route_puzzle:[
  {prompt:'Pick the strongest route stop',choices:['0.4 mi · verified 10m ago · accessible','0.1 mi · no evidence in 2 years','0.3 mi · rating only'],correct:0,detail:'A small distance tradeoff buys much stronger confidence.'},
  {prompt:'You need a changing table.',choices:['0.5 mi · table verified today','0.2 mi · amenity unknown','0.4 mi · old “family friendly” tag'],correct:0,detail:'Route utility depends on the amenity you need.'}],
 ranking:[
