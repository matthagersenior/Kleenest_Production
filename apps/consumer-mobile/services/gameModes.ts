...
export const GAME_DEFINITIONS:GameDefinition[]=[
 ...
 {code:'stall_strategy',name:'Stall Strategy',description:'Spend a limited evidence budget where it builds the most trust.',mode:'strategy',rounds:6,accent:'♟️',instructions:'Spend evidence tokens carefully. Stronger moves cost more.',basePoints:20,difficulty:'hard',strategyBudget:20},
