  ...
  return <SafeAreaView style={[s.safe,{backgroundColor:theme.canvas}]}>
    <ScrollView contentContainerStyle={s.content}>
      <View style={[s.hero,{backgroundColor:theme.accent}]}>
        <Text style={[s.eyebrow,{color:theme.accentText,opacity:.78}]}>OFFLINE TRIPS</Text>
        <Text style={[s.heroTitle,{color:theme.accentText}]}>Take trusted restroom context with you.</Text>
        <Text style={[s.heroBody,{color:theme.accentText,opacity:.88}]}>Saved routes prepare a canonical Supabase corridor, then copy that exact restroom snapshot onto this device. When the network disappears, the local copy remains readable until the pack expires.</Text>
