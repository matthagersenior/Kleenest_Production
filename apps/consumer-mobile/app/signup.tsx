...
export default function SignupScreen(){
 ...
 return <SafeAreaView style={[s.safe,{backgroundColor:theme.canvas}]}><ScrollView contentContainerStyle={[s.page,{backgroundColor:theme.canvas}]} keyboardShouldPersistTaps="handled">
