...
export default function GameArena(){
 ...
 return <SafeAreaView style={[s.safe,{backgroundColor:ui.canvas}]}><ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
  <View style={[s.hero,{backgroundColor:arena.surface}]}>
   <View style={s.topRow}><Pressable accessibilityRole="button" accessibilityLabel="Back to Arcade" onPress={()=>router.replace('/games')} style={s.back}><Text style={s.backText}>‹ ARCADE</Text></Pressable><Text style={[s.arenaLabel,{color:arena.accent}]}>{arena.label}</Text></View>
