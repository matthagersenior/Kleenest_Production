...
export default function LegalCenter(){
  ...
  return <ScrollView contentContainerStyle={[page,{backgroundColor:theme.canvas}]}>
    ...
    <View style={[card,{backgroundColor:theme.surface,borderColor:theme.line}]}><Text style={[heading,{color:theme.ink}]}>Your controls</Text><Text style={[body,{color:theme.muted}]}>Report unsafe content or contributors from their content/profile. Blocked contributors cannot continue direct interaction with you. You can manage blocked users and account deletion from Profile.</Text><Link href="/blocked-users" asChild><Pressable style={[secondary,{backgroundColor:theme.surfaceRaised,borderColor:theme.line}]}><Text style={[secondaryText,{color:theme.accent}]}>Manage blocked users</Text></Pressable></Link><Link href="/account-deletion" asChild><Pressable style={[secondary,{backgroundColor:theme.surfaceRaised,borderColor:theme.line}]}><Text style={[secondaryText,{color:theme.accent}]}>Account deletion</Text></Pressable></Link></View>
