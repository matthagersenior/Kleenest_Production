...
export default function HomeScreen(){
  ...
  return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
    ...
    <View style={s.twoCol}>
      <FeatureCard kicker="NEARBY / ADDRESS" title="Find a restroom" body="Search from your location or any entered address with amenities, trust, distance, details and directions." onPress={action('/explore')}/>
      <FeatureCard kicker="SCAN QR" title="Check in / review" body="Scan a Kleenest QR to check in, review, verify trust missions or resolve the location action." onPress={action('/qr')}/>
