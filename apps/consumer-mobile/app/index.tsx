...
export default function HomeScreen(){
  return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
    ...
    <SectionHeader eyebrow="YOUR NETWORK" title="Community makes the map smarter" body="Follow useful contributors, inspect verified evidence, and see what your network is learning about local bathrooms."/>
    <View style={s.stack}>
    ...
    <View style={s.moreRow}>
      <Pressable style={s.more} onPress={action('/membership')}><Text style={s.moreTitle}>Membership</Text><Text style={s.moreBody}>Benefits + billing</Text></Pressable>
