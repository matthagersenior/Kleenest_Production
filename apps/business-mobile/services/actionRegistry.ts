...
export const BUSINESS_ACTIONS:BusinessActionDefinition[]=[
  ...
  {id:'smart-devices',title:'Operate IoT & Smart Devices',description:'Register connected-facility bridges and devices, inspect telemetry, send audited device commands and create safe automations.',route:'/devices',group:'Trust & Operations',serviceActions:['upsertSmartDeviceConnector','upsertSmartDevice','smartDeviceCommand','smartDeviceSetAutomationRule'],keywords:['iot','smart bathroom','sensor','matter','mqtt','device','telemetry','automation']},
