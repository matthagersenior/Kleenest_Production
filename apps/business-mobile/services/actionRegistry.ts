...
export const BUSINESS_ACTIONS:BusinessActionDefinition[]=[
  ...
  {id:'media',title:'Manage official media & community disputes',description:'Manage Business-owned location media and flag community photo evidence for moderation without curating user submissions.',route:'/growth',group:'Growth & QR',serviceActions:['createBusinessMedia','updateBusinessMedia','deleteBusinessMedia','disputeBusinessReviewPhoto']},
  ...
  {id:'smart-devices',title:'Operate Smart Restrooms & Devices',description:'Confirm the Smart Restroom amenity, register connected-facility bridges/devices, create verification or command QR, inspect telemetry, send audited commands and create safe automations.',route:'/devices',group:'Trust & Operations',serviceActions:['setSmartRestroomAmenity','createSmartRestroomQr','executeSmartDeviceQr','smartRestroomSnapshot','upsertSmartDeviceConnector','upsertSmartDevice','smartDeviceCommand','smartDeviceSetAutomationRule'],keywords:['iot','smart restroom','smart bathroom','connected restroom','sensor','matter','mqtt','device','telemetry','automation','qr']},
