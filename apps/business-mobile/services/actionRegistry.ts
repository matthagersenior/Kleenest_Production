...
export const BUSINESS_ACTIONS:BusinessActionDefinition[]=[
  ...
  {id:'location-enterprise',title:'Configure Enterprise locations',description:'Set location-level Enterprise configuration and staff authority.',route:'/enterprise-locations',group:'Enterprise',serviceActions:['updateEnterpriseLocationConfig','manageEnterpriseLocationStaff']},
  ...
  {id:'media',title:'Manage business media',description:'Create, update and remove Business media used by customer-facing experiences.',route:'/growth',group:'Growth & QR',serviceActions:['createBusinessMedia','updateBusinessMedia','deleteBusinessMedia']},
