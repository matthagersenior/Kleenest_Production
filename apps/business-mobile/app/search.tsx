...
export default function GlobalSearch(){
 ...
 const indexed=useMemo(()=>searchAppIndex('business',query,34),[query,capabilities]);
 ...
 return <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={[s.page,{backgroundColor:theme.canvas}]}>
  <View style={[s.hero,{backgroundColor:theme.surface,borderColor:theme.line}]}>
   ...
   <TextInput autoFocus value={query} onChangeText={setQuery} onSubmitEditing={()=>void search()} placeholder="Try “claims”, “Growth”, a location, or team member…" placeholderTextColor={theme.muted} style={[s.input,{backgroundColor:theme.surfaceRaised,borderColor:theme.line,color:theme.ink}]}/>
  </View>
