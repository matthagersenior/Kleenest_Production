...
const s=StyleSheet.create({
 ...
 hero:{backgroundColor:'#123a2a',padding:14,borderRadius:18,gap:8,shadowColor:'#0b251a',shadowOpacity:.08,shadowRadius:8,shadowOffset:{width:0,height:3},elevation:2},
 heroTop:{flexDirection:'row',alignItems:'center',gap:12},
 brandMark:{width:36,height:36,borderRadius:11,backgroundColor:'#d7ad5b',alignItems:'center',justifyContent:'center'},
 brandMarkText:{fontSize:18,fontWeight:'900',color:'#123a2a'},
 eyebrow:{fontSize:9,fontWeight:'900',letterSpacing:1.35,color:'#bfe2cf'},
 title:{fontSize:22,lineHeight:26,fontWeight:'900',color:'#fff',marginTop:1},
 heroBody:{fontSize:12,lineHeight:18,color:'#e1ece6'},
 ...
 heroStat:{flex:1,backgroundColor:'#1d4935',borderRadius:12,padding:8,minHeight:56,justifyContent:'center'},
 heroStatValue:{fontSize:18,fontWeight:'900',color:'#fff'},
 heroStatLabel:{fontSize:9,lineHeight:12,fontWeight:'800',color:'#bfe2cf',marginTop:1},
