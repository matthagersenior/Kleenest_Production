...
const domainSpecs:Domain[]=[
 ...
 {href:'/advertising',title:'Sponsored Ads',body:'Create Kleenest Sponsored placements by context, route and amenity without buying organic rank.',gate:'always',glyph:'◎',group:'Grow'},
 {href:'/engagement',title:'Campaigns & Promotions',body:'Create and manage promotions, campaigns, contests and events.',gate:'advancedEngagement',glyph:'↗',group:'Grow'},
 {href:'/growth',title:'Growth Performance',body:'Measure visits, offers, campaign activity and repeat engagement outcomes.',gate:'advancedEngagement',glyph:'↑',group:'Grow'},
