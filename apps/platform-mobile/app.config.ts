...
const config:ExpoConfig={
  ...
  android:{package:'com.kleenest.platform',icon:'./assets/app-icon.png',blockedPermissions:['android.permission.ACCESS_BACKGROUND_LOCATION','android.permission.RECORD_AUDIO','android.permission.SYSTEM_ALERT_WINDOW']},
