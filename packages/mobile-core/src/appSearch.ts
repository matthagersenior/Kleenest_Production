...
const INDEX:Record<AppSearchScope,AppSearchEntry[]>={
  ...
  fleet:[
    ...
    {id:'member',title:'For Me',subtitle:'Fleet member experience',category:'Page',route:'/member',keywords:['for me','member','driver view']},
    {id:'onboarding',title:'Onboarding',subtitle:'Complete Fleet workspace setup',category:'Action',route:'/onboarding',keywords:['onboarding','setup']},
    {id:'demo',title:'Guided Demo',subtitle:'Walk through Fleet capabilities',category:'Knowledge',route:'/demo',keywords:['demo','guided demo','tour']},
