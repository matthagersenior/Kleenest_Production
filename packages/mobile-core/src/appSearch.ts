...
const INDEX:Record<AppSearchScope,AppSearchEntry[]>={
  ...
  business:[
    ...
    {id:'advertising',title:'Sponsored Ads',subtitle:'Create contextual Kleenest Sponsored placements for consumers',detail:'Build tasteful paid recommendations that fit the Kleenest workflow. Target coarse area, route context, amenities, time context and broad interests without changing organic trust, freshness, verification or ranking.',category:'Action',route:'/advertising',keywords:['advertise','advertising','ads','sponsored','sponsored ads','Kleenest ad','sponsorship','promote','promotion','targeting','native ad']},
    {id:'campaigns-promotions',title:'Campaigns & Promotions',subtitle:'Create campaigns, promotions, contests and events',category:'Action',route:'/engagement',keywords:['growth','engagement','campaign','campaigns','promotion','promotions','contest','contests','event','events','marketing']},
    ...
    {id:'growth-performance',title:'Growth Performance',subtitle:'Read-only visits, attribution and program results',category:'Data',route:'/growth',keywords:['growth performance','growth metrics','attribution','repeat engagement','redemptions','campaign results']},
    {id:'location-media',title:'Official Location Media',subtitle:'Manage Business-owned location photos separately from community evidence',category:'Operations',route:'/location-media',keywords:['official media','official photos','business photos','location photos','upload photo','media']},
