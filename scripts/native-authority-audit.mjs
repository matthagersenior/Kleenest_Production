...
if(!failures.length){
 ...
 expect(hasNearbyAuthority&&explore.includes('requestForegroundPermissionsAsync')&&explore.includes('Location.geocodeAsync')&&explore.includes('searchAreaOrigin')&&explore.includes('listLocationTrustSummaries')&&hasRouteHandoff&&hasDetailsHandoff&&explore.includes("router.push('/discover')"),'Explore must preserve bathroom discovery, address-origin search, trust, route, details handoff and missing-place discovery entry');
