...
const required=[
 'package.json','packages/mobile-core/package.json','packages/mobile-core/src/index.ts','packages/mobile-core/src/publicEntry.ts','packages/mobile-core/src/privateActivity.ts','apps/consumer-mobile/package.json','apps/consumer-mobile/app.config.ts','apps/consumer-mobile/eas.json','apps/consumer-mobile/app/_layout.tsx','apps/consumer-mobile/app/index.tsx','apps/consumer-mobile/app/explore.tsx','apps/consumer-mobile/app/play.tsx','apps/consumer-mobile/app/route.tsx','apps/consumer-mobile/app/profile.tsx','apps/consumer-mobile/app/preferences.tsx','apps/consumer-mobile/app/location/[id].tsx','apps/consumer-mobile/app/saved.tsx','apps/consumer-mobile/app/activity.tsx','apps/consumer-mobile/services/activity.ts','apps/consumer-mobile/app/notifications.tsx','apps/consumer-mobile/services/notificationInbox.ts','apps/consumer-mobile/app/social.tsx','apps/consumer-mobile/app/membership.tsx'
];
for(const file of required)if(!exists(file))failures.push(`missing native authority file: ${file}`);
if(!failures.length){
 const pkg=read('package.json'),corePkg=read('packages/mobile-core/package.json'),core=read('packages/mobile-core/src/index.ts'),publicEntry=read('packages/mobile-core/src/publicEntry.ts'),privateActivity=read('packages/mobile-core/src/privateActivity.ts'),appPkg=read('apps/consumer-mobile/package.json'),appConfig=read('apps/consumer-mobile/app.config.ts'),layout=read('apps/consumer-mobile/app/_layout.tsx'),home=read('apps/consumer-mobile/app/index.tsx'),explore=read('apps/consumer-mobile/app/explore.tsx'),play=read('apps/consumer-mobile/app/play.tsx'),route=read('apps/consumer-mobile/app/route.tsx'),profile=read('apps/consumer-mobile/app/profile.tsx'),preferences=read('apps/consumer-mobile/app/preferences.tsx'),location=read('apps/consumer-mobile/app/location/[id].tsx'),saved=read('apps/consumer-mobile/app/saved.tsx'),activity=read('apps/consumer-mobile/app/activity.tsx'),activityService=read('apps/consumer-mobile/services/activity.ts'),notifications=read('apps/consumer-mobile/app/notifications.tsx'),notificationInbox=read('apps/consumer-mobile/services/notificationInbox.ts'),social=read('apps/consumer-mobile/app/social.tsx'),membership=read('apps/consumer-mobile/app/membership.tsx');
 ...
 expect(explore.includes('listNearbyRestrooms')&&explore.includes('requestForegroundPermissionsAsync')&&explore.includes('listLocationTrustSummaries')&&hasRouteHandoff&&hasDetailsHandoff,'Explore must preserve bathroom discovery, trust, route and details handoff');
