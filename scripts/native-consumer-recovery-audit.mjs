...
const failures=[];
const required=['apps/consumer-mobile/app/qr.tsx','apps/consumer-mobile/app/route.tsx','apps/consumer-mobile/app/location/[id].tsx','apps/consumer-mobile/app/saved.tsx'];
...
if(!failures.length){
 ...
 if(/service_role|record_data_feature_event/.test(qr+route+location+saved))failures.push('Consumer recovery surfaces must not introduce privileged backend authority.');
}
