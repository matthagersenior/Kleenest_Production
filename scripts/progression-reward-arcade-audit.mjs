...
const files={
 ...
 ownerMigration:fs.readFileSync('supabase/migrations/20260914150017_seasonal_progression_reward_vault.sql','utf8')+fs.readFileSync('supabase/migrations/20260915154500_enable_seasonal_theme_progression.sql','utf8')+fs.readFileSync('supabase/migrations/20260916013000_progression_reward_inventory_arcade_expansion.sql','utf8'),
};
