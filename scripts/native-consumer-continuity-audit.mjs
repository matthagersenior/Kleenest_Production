...
if(!failures.length){
 ...
 if(!explore.includes("Live lookup failed. Showing cached bathrooms")||!explore.includes("tap Search for a live result"))failures.push('Explore must clearly distinguish cached fallback from live discovery and expose explicit Search recovery.');
