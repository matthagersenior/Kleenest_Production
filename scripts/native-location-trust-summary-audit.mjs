...
if(!failures.length){
 ...
 if(!explore.includes('verified visit')||!explore.includes('photo')||!explore.includes('observed amenit')||!explore.includes('Evidence ${fresh}'))failures.push('Explore must surface verified visits, photos, amenity evidence and freshness.');
