...
if(!failures.length){
  ...
  for(const token of ['public.my_activity_feed','security definer',"set search_path = ''",'public.check_ins','public.reviews','public.social_activity'])if(!migration.includes(token))failures.push(`Activity migration missing authority token: ${token}`);
