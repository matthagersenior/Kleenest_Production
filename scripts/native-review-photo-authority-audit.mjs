...
if(!failures.length){
  ...
  if(!strip.includes('getReviewEvidence')||!strip.includes('VERIFIED VISIT')||!strip.includes('formatVisitEvidence')||!strip.includes('evidenceCountLabel')||!strip.includes('photo_evidence_count')||!strip.includes('amenity_evidence_count')) failures.push('Review cards must surface shared verified visit freshness and evidence counts.');
