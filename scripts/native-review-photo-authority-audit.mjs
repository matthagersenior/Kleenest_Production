...
if(!failures.length){
  ...
  if(!strip.includes('getReviewEvidence')||!strip.includes('VERIFIED VISIT')||!strip.includes('amenities observed')||!strip.includes('visitFreshness')) failures.push('Review cards must surface verified visit freshness and evidence counts.');
