...
const evidence={
 ...
 business:{
  ...
  markers:[
   ['services/product.ts','business_list_workspaces'],['services/product.ts','business_manage_location'],['services/product.ts','business_reply_review'],['services/product.ts','business_manage_promotion'],['services/product.ts','business_manage_campaign'],['services/product.ts','business_manage_contest'],['services/product.ts','business_manage_event'],['services/product.ts','business_manage_qr'],['services/product.ts','business_create_custom_qr'],['services/product.ts','business_list_media_v2'],['services/product.ts','business_list_location_community_photos'],['services/product.ts','business_dispute_review_photo'],['services/product.ts','business_update_media'],['app/reviews.tsx','Community photo evidence'],['app/reviews.tsx','Flag / dispute'],['services/product.ts','business_restroom_remediation_operations'],['services/product.ts','business_manage_restroom_remediation'],['services/product.ts','business_reverification_queue'],['services/product.ts','business_manage_reverification_case'],['services/product.ts','business_restroom_preventive_work_orders'],['services/product.ts','business_manage_restroom_preventive_work_order'],['services/product.ts','enterprise_control_plane_snapshot'],['services/product.ts','enterprise_list_owned_networks'],['services/product.ts','enterprise_list_partner_businesses'],
