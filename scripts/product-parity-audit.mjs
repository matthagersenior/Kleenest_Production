...
const evidence={
 ...
 business:{
  ...
  markers:[
   ...
   ['services/control.ts','kleenest.business.selected_workspace.v1'],['services/control.ts','currentBusinessId'],
   ['services/capabilityWorkflows.ts','business_live_network_manifest'],['services/capabilityWorkflows.ts','business_progression_engagement_snapshot'],['services/capabilityWorkflows.ts','business_invite_member'],['services/capabilityWorkflows.ts','business_transfer_ownership'],
