...
const explore=requireAll('apps/consumer-mobile/app/explore.tsx',['Find a trusted bathroom.','BEST NEXT DECISION','What matters on this stop?','Start directions →','listLocationTrustSummaries','listNearbyRestrooms']);
