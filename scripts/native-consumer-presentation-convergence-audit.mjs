...
const location=requireAll('apps/consumer-mobile/app/location/[id].tsx',['KLEENEST RESTROOM','TrustStrip','BEFORE YOU GO','VISIT + CONTRIBUTE','Start directions','Verify my visit','LocationAmenityInventory','createMobileReview','uploadReviewPhotos','completeTrustMission']);
...
const membership=requireAll('apps/consumer-mobile/app/membership.tsx',['More confidence wherever you go.','WHY KLEENEST','Native purchase boundary','Find a bathroom','getMobileAccountSummary','listMobilePricingCatalog']);
