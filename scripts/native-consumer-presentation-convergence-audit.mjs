...
const membership=requireAll('apps/consumer-mobile/app/membership.tsx',['Choose the membership that fits you.','Consumer capabilities stay coherent across membership.','Premium adds its entitled value','5-seat Family option','Verified mobile entitlement','App Store / Google Play billing','purchase/restore must be verified before entitlement changes','Kleenest AI','offline trips','Find a bathroom','getMobileAccountSummary','listMobilePricingCatalog']);
