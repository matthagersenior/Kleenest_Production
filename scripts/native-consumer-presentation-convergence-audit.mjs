...
const location=requireAll('apps/consumer-mobile/app/location/[id].tsx',['KLEENEST RESTROOM','TRUST SNAPSHOT','VISIT + CONTRIBUTE','Directions','Verify visit','LocationAmenityInventory','createMobileReview','uploadReviewPhotos','completeTrustMission']);
