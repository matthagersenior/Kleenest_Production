...
if(!failures.length){
  ...
  for(const token of ['Search this area','Results are below','resultsPeek','What matters on this stop?','Start directions','Address, school, workplace, city or brand'])if(!explore.includes(token))failures.push(`Explore bathroom-first map-first discovery contract missing ${token}.`);
