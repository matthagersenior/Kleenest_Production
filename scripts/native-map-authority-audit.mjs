...
if(!failures.length){
 ...
 if(!/listNearbyRestrooms\(current\.coords\.latitude,current\.coords\.longitude,radius,query,selectedAmenityNames,?\)/.test(exploreCompact))failures.push('Explore must use the single nearby-restroom service with radius/search/amenity inputs.');
