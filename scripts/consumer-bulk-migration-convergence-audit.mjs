...
if(!failures.length){
  ...
  for(const token of ["'/explore'",'/saved','/qr','THE KLEENEST LOOP','YOUR NETWORK'])if(!home.includes(token))failures.push(`Home missing rich bathroom-first activation capability: ${token}`);
