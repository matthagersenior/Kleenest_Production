...
const files={
  ...
  heroRelevance:'apps/consumer-mobile/services/heroRelevance.ts'
};
...
if(!failures.length){
 ...
 for(const token of ['organizeDiscoveryRows','Search this area','Results ↓','resultsHandoff','SponsoredSlot surface="maps"'])if(!adaptiveExplore.includes(token))failures.push(`Explore functional-home activation missing ${token}.`);
