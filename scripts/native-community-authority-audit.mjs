...
const required=['apps/consumer-mobile/services/community.ts','apps/consumer-mobile/services/contributors.ts','apps/consumer-mobile/app/location/[id].tsx','apps/consumer-mobile/app/social.tsx','apps/consumer-mobile/app/contributor/[id].tsx','supabase/migrations/20260830224000_canonical_community_contributor_profiles.sql'];
const failures=[];
