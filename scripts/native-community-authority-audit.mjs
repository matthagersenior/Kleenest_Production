...
if(!failures.length){
  ...
  if(!core.includes("rpc('community_following_review_activity'")||!core.includes('listMobileCommunityActivity')) failures.push('Community pulse must use the canonical followed-review activity RPC.');
