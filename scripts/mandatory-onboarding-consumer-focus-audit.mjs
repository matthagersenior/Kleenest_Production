...
for(const token of ['SponsoredSlot surface="maps"','Search this area','Results are below','resultsPeek','organizeDiscoveryRows']) if(!explore.includes(token)) failures.push('Explore functional home focal hierarchy missing '+token);
