...
if(!failures.length){
  ...
  if(!play.includes('listTrustMissionHistory')||!play.includes('completedTrustMissions')||!play.includes('ACTIVE TRUST MISSION')||!play.includes('missionTierLabel')||!play.includes("?'FULL EVIDENCE':'VERIFIED VISIT'")||!play.includes('View strengthened restroom')||!play.includes("pathname:'/location/[id]'"))failures.push('Play must surface authoritative active mission state, reward tiers, history, and restroom navigation.');
