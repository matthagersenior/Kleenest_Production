...
const businessOfficialMedia=read('apps/business-mobile/app/location-media.tsx');
...
requireTokens('Business location UI',businessLocations,['Add official photo','Official media']);
requireTokens('Business official media UI',businessOfficialMedia,['OFFICIAL LOCATION MEDIA','pickAndUploadBusinessLocationPhoto','businessLocationPhotoUrl','updateBusinessMedia','deleteBusinessMedia']);
requireTokens('Business review photo disputes UI',businessReviews,['Community photo evidence','Flag / dispute','disputeBusinessReviewPhoto','businessReviewPhotoUrl']);
