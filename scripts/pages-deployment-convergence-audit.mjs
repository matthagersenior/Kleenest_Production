...
for(const token of ['Publish Consumer Standalone Installer','Build Consumer Standalone Android APK','Kleenest-Consumer-Standalone-APK','Kleenest-Consumer.apk','actions/configure-pages@v5','actions/upload-pages-artifact@v3','actions/deploy-pages@v4','path: apps/consumer-mobile/dist'])requireToken(installer,token,'Consumer installer deployment workflow');
