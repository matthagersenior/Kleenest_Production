...
const fleetPkg=JSON.parse(read('apps/fleet-mobile/package.json'));
const fleetMetro=read('apps/fleet-mobile/metro.config.js');
const fleetSecurePreview=read('apps/fleet-mobile/web/secureStorePreview.ts');
const fleetNotificationsPreview=read('apps/fleet-mobile/web/notificationsPreview.ts');
const fleetTaskPreview=read('apps/fleet-mobile/web/taskManagerPreview.ts');
const consumerLayout=read('apps/consumer-mobile/app/_layout.tsx');
const operatorOAuthRelay=read('apps/consumer-mobile/services/operatorOAuthRelay.ts');
...
for(const token of ['Validate Kleenest Consumer Web Preview','npm run web:export --workspace @kleenest/business-mobile','apps/business-mobile/dist/index.html','npm run web:export --workspace @kleenest/fleet-mobile','apps/fleet-mobile/dist/index.html','npm run web:export --workspace @kleenest/owner-mobile','apps/platform-mobile/dist/index.html','kleenest-consumer-preview-validation-${{ github.event_name }}','workflow_dispatch','pull_request','workflow_run','Production CI','conclusion == \'success\'','head_branch == \'main\'','github.event.workflow_run.head_sha','npm run web:export --workspace @kleenest/consumer-mobile','node scripts/prepare-consumer-web-pwa.mjs','apps/consumer-mobile/dist/index.html','apps/consumer-mobile/dist/profile/index.html','apps/consumer-mobile/dist/404.html','apps/consumer-mobile/dist/.nojekyll','actions/upload-artifact@v4','Kleenest-Consumer-Web-Preview'])requireToken(pages,token,'Pages consumer preview validation workflow');
...
for(const token of ['Publish Consumer Standalone Installer','Validate Kleenest Consumer Web Preview','Resolve freshest verified Consumer APK','consumer-release-drift-audit.mjs','Kleenest-release-state.json','npm run web:export --workspace @kleenest/business-mobile','apps/business-mobile/dist','apps/consumer-mobile/dist/business','cp -R apps/business-mobile/dist/. apps/consumer-mobile/dist/business/','npm run web:export --workspace @kleenest/fleet-mobile','apps/fleet-mobile/dist','apps/consumer-mobile/dist/fleet','cp -R apps/fleet-mobile/dist/. apps/consumer-mobile/dist/fleet/','fleet_routes=','business_routes=','test -s apps/consumer-mobile/dist/fleet/dispatch/index.html','test -s apps/consumer-mobile/dist/fleet/nearby/index.html','test -s apps/consumer-mobile/dist/fleet/operations/index.html','test -s apps/consumer-mobile/dist/business/tools/index.html','test -s apps/consumer-mobile/dist/business/fleet/index.html','test -s apps/consumer-mobile/dist/business/analytics/index.html','test -s apps/consumer-mobile/dist/business/enterprise-location-admin/index.html','npm run web:export --workspace @kleenest/owner-mobile','apps/platform-mobile/dist','apps/consumer-mobile/dist/owner','KleenestOS Web','test -s apps/consumer-mobile/dist/owner/index.html','Kleenest-Consumer-Standalone-APK','Kleenest-Consumer.apk','node scripts/prepare-consumer-web-pwa.mjs','manifest.webmanifest','sw.js','app-icon.png','app-icon-512.svg','apps/consumer-mobile/dist/profile/index.html','mkdir -p apps/consumer-mobile/dist/legal','cp public/legal/*.html apps/consumer-mobile/dist/legal/','cp -R apps/developer-portal/static/. apps/consumer-mobile/dist/developer/','cp -R apps/platform-mobile/dist/. apps/consumer-mobile/dist/owner/','owner_routes=','test -s apps/consumer-mobile/dist/developer/index.html','test -s apps/consumer-mobile/dist/developer/manifest.webmanifest','test -s apps/consumer-mobile/dist/owner/control/index.html','Kleenest Developer Portal','Browser token','for legal in privacy account-deletion.html terms community-guidelines','actions/configure-pages@v5','actions/upload-pages-artifact@v3','actions/deploy-pages@v4','path: apps/consumer-mobile/dist'])requireToken(installer,token,'Consumer + Developer Portal Pages deployment workflow');
...
for(const token of ['isTaskDefined','defineTask','isTaskRegisteredAsync'])requireToken(fleetTaskPreview,token,'Fleet task-manager web adapter');
...
for(const token of ['group: kleenest-family-ota',"cancel-in-progress: ${{ github.event.workflow_run.conclusion == 'success' }}"])requireToken(familyOta,token,'Coordinated family OTA concurrency policy');
