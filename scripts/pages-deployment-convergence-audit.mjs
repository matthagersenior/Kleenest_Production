...
for(const token of ['Publish Consumer Standalone Installer','Build Kleenest App Family Android APKs','Kleenest-Consumer-Standalone-APK','Kleenest-Consumer.apk','mkdir -p apps/consumer-mobile/dist/legal','cp public/legal/*.html apps/consumer-mobile/dist/legal/','mkdir -p apps/consumer-mobile/dist/developer','cp apps/developer-portal/static/index.html apps/consumer-mobile/dist/developer/index.html','test -s apps/consumer-mobile/dist/developer/index.html','Kleenest Developer Portal','Browser token','for legal in privacy account-deletion terms community-guidelines','test -s "apps/consumer-mobile/dist/legal/${legal}.html"','actions/configure-pages@v5','actions/upload-pages-artifact@v3','actions/deploy-pages@v4','path: apps/consumer-mobile/dist'])requireToken(installer,token,'Consumer + Developer Portal Pages deployment workflow');
