...
if(!failures.length){
 ...
 if(!scoring.includes('scoreRound')||!scoring.includes("'arena_v4':'arena_v3'")||!arena.includes('gameResultMetadata')||!arena.includes('masteryRating'))failures.push('Game Center must preserve arena_v3 scoring while advanced arenas use arena_v4.');
