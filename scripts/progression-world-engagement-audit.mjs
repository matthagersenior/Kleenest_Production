...
expect(migrations,/contributor_trust/i,'Progression World must expose evidence-backed contributor trust.');
expect(migrations,/game_play[\s\S]*not/i,'Game XP must not directly raise Contributor Trust.');
