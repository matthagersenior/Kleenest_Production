...
const actionVerb=/^(run|preview|select|invite|change|remove|transfer|reply|upsert|restore|save|archive|create|update|delete|claim|ensure|send|execute|complete|manage|set|activate|pause|record|configure|request|start|disable|register|apply|advance|reset|attach|pick)/;
