  ...
  where l.is_active=true
    ...
    and (
      ...
      or exists (
        ...
        join amenities aa on aa.id=la.amenity_id
...
select
  ...
  coalesce(r.p_category,r.place_type,'service'),
  r.address,
  r.city,
  r.state,
  r.postal_code,
  ...
  coalesce(r.source_metadata->>'brand',r.source_metadata->>'brand_name'),
  coalesce(r.source_metadata->>'operator',r.source_metadata->>'operator_name'),
