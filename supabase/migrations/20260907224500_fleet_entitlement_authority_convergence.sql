...
-- Keep manager/operator authorization separate from entitlement calculation: a caller must
-- both manage the Business workspace and have canonical fleet_enabled access.
