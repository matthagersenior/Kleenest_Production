...
begin
 ...
 if v_program is null then
  insert into public.partner_programs(business_id,name,enabled,preferred_access,status,is_demo_test)
  values(v_a,'Demo Preferred Partner Program',true,true,'active',true) returning id into v_program;
 else
