...
begin
 ...
 for item in select value from jsonb_array_elements(p_rows) loop
  begin
   ...
   v_generic_name := lower(v_name) in ('public place','public restroom','unnamed service','unnamed restroom','unnamed restaurant','unnamed cafe','unnamed park','unnamed health','unnamed gas_station','unnamed shopping') or lower(v_name) like 'unnamed %';
   ...
   if loc_id is null and not v_generic_name then
